...
trait BuildFromLowPriority1 extends BuildFromLowPriority2 {
  ...
  // implicit def buildFromSortedSetOps[UnsortedCC[X] <: Set[X], CC[X] <: SortedSet[X] with UnsortedCC[X] with SortedSetOps[X, UnsortedCC, CC, _], A0, A : Ordering]: BuildFrom[CC[A0], A, CC[A]] = new BuildFrom[CC[A0], A, CC[A]] {
  implicit def buildFromSortedSetOps[CC[X] <: SortedSet[X] with SortedSetOps[X, Set, CC, _], A0, A : Ordering]: BuildFrom[CC[A0], A, CC[A]] = new BuildFrom[CC[A0], A, CC[A]] {
